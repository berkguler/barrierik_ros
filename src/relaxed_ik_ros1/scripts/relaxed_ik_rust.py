...
class RelaxedIK:
    ...
    def set_target(self, position, orientation):
        #Compatible function for the RIK_PKG version
        positions = []
        orientations = []
        tolerances = []
        ...
        orientations.append(orientation.x)
        orientations.append(orientation.y)
        orientations.append(orientation.z)
        orientations.append(orientation.w)
    ...
    def run(self, q):
        ik_solution = self.relaxed_ik.solve_position(self.positions, self.orientations, self.tolerances)
        return ik_solution
